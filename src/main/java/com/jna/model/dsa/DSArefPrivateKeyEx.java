...
public class DSArefPrivateKeyEx extends Structure implements IDSArefPrivateKey {
    ...
    public void decode(byte[] bytes) {
        ...
        if (pos != bytes.length) {
            throw new RuntimeCryptoException("inputData length != DSArefPrivateKeyEx length");
        }
    }
    ...
    public byte[] encode() {
        ...
        try {
            ...
            throw new RuntimeCryptoException("DSArefPrivateKeyEx encode error." + ex.getMessage());
        }
